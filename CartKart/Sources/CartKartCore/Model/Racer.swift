...
public struct PhysicsProfile: Sendable {
    ...
    public init(profile: RacerProfile, tuning: RaceTuning = .default) {
        ...
        self.topSpeed = tuning.baseTopSpeed * scale(profile.speed, 0.075)
        self.acceleration = tuning.baseAcceleration * scale(profile.acceleration, 0.11)
        self.grip = tuning.baseGrip * scale(profile.handling, 0.09)
